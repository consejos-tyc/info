    ...
    <div className="space-y-8 animate-fade-in pb-12">
      <div className="bg-white border border-[#E0E0E0] p-10 rounded-lg shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          ...
          <p className="text-[#666]">Recursos y presentaciones para el fortalecimiento de las Estacas y Distritos</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-[#E0E0E0] rounded-xl overflow-hidden hover:shadow-xl transition-all group">
          ...
          <div className="p-8 text-center">
            <h3 className="text-xl font-serif font-bold text-[#333] mb-3">Líderes de Estaca y Distrito</h3>
            <p className="text-sm text-[#666] mb-8">Capacitaciones para presidentes de Estaca y Distrito</p>
            <a 
        ...
        <div className="bg-white border border-[#E0E0E0] rounded-xl overflow-hidden hover:shadow-xl transition-all group">
          ...
          <div className="p-8 text-center">
            <h3 className="text-xl font-serif font-bold text-[#333] mb-3">Secretarios de estaca y Distritos</h3>
            <p className="text-sm text-[#666] mb-8">Capacitaciones y Recursos para Secretarios de Estaca y Distrito</p>
            <a 
